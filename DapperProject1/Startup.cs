...
namespace DapperProject1
{
    public class Startup
    {
        ...
        {
            string connectionMaster = "Server=tcp:dapperproject120170508120848dbserver.database.windows.net,1433;Database="+ MasterConnection.GetDatabaseName()+";User ID=TryUser@dapperproject120170508120848dbserver;Password=Oi335435335435;";
            ...
            string connectionString = "Server=tcp:dapperproject120170508120848dbserver.database.windows.net,1433;Database=" + MasterConnection.GetDatabaseName()+ ";User ID=TryUser@dapperproject120170508120848dbserver;Password=Oi335435335435;";
